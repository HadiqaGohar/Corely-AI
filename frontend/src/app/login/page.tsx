    ...
    <div className="relative min-h-screen flex items-center justify-center px-4">
      ...
      <div className="relative z-10 w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="mb-1.5 flex items-center justify-between">
                ...
                <Link href="/forgot-password" className="text-xs text-[var(--accent)] hover:text-[#5b4de0] transition-colors">
                  Forgot password?
                </Link>
              </div>
        ...
        <p className="mt-6 text-center text-sm text-[var(--text-dim)]">
          ...
          <Link href="/register" className="font-medium text-[var(--accent)] hover:text-[#5b4de0] transition-colors">
            Sign up
          </Link>
        </p>
      </div>
