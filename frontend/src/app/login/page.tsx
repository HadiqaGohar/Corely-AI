      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="glass rounded-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="mb-1.5 flex items-center justify-between">
                <label htmlFor="password" className="text-xs font-medium text-[var(--text-dim)]">
                  Password
                </label>
                <Link href="/forgot-password" className="text-xs text-[var(--accent)] hover:text-[var(--accent2)] transition-colors">
                  Forgot password?
                </Link>
              </div>
          ...
          <div className="space-y-3">
            <button className="btn-ghost flex w-full items-center justify-center gap-3 rounded-xl py-2.5 text-sm font-medium">
        ...
        <p className="mt-6 text-center text-sm text-[var(--text-dim)]">
          ...
          <Link href="/register" className="font-medium text-[var(--accent)] hover:text-[var(--accent2)] transition-colors">
            Sign up
          </Link>
        </p>
      </div>
