...
const socials = [
  {
    label: "GitHub",
    href: "https://github.com/HadiqaGohar/Corely-AI",
    icon: (
      ...
      <div className="mx-auto max-w-6xl px-6 py-16">
        <div className="flex flex-col gap-12 md:flex-row md:justify-between">
          ...
          <div className="max-w-xs">
            ...
            <p className="text-sm leading-relaxed text-[var(--text-dim)]">
              Your all-in-one AI productivity workspace. Chat, manage tasks,
        ...
        <div className="mt-14 flex flex-col items-center justify-between gap-4 border-t border-[var(--border)] pt-8 md:flex-row">
          <p className="text-xs text-[var(--text-dim)]">
            © {new Date().getFullYear()} Corely AI. All rights reserved.
          </p>
